 ...
 * 如果使用了默认的LocalDateDeserializer反序列化UTC格式的字符串，会报错 "Cannot deserialize value of
 * type `java.time.LocalDate` from String "2020-11-03T20:07:55"
...
public class LocalDateUtcDeserializer extends JsonDeserializer<LocalDate> {
    ...
    @Override
    public LocalDate deserialize(final JsonParser jsonParser, final DeserializationContext ctx)
