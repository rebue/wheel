...
public class IdCardValidator {
    ...
    // private static Map<Integer, String> _addresses = new HashMap<Integer,
    // String>();
    ...
    // private final static long MINIMAL_BORN_DATE = new DateTime(1900, 1, 1, 0,
    // 0).getMillis();

    // 时间解析器
    private static final TimeParseFixer _timeParseFixer;
    ...
    public static boolean validate(final String sNumber) {
        ...
        // _logger.error("身份证号码中的日期小于" + new DateTime(MINIMAL_BORN_DATE) + "或者大于当前时间：" +
        // sNumber);
        // return false;
        // }
        Date         birthday;
