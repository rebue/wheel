...
public abstract class PropertyNamingStrategiesEx implements java.io.Serializable {
     ...
     *
     * <ul>
     * <li>Every upper case letter in the Java property name is translated
     * into two characters, an underscore and the lower case equivalent of the
     * target character, with three exceptions.
     * <ol>
     * <li>For contiguous sequences of upper case letters, characters after
     * the first character are replaced only by their lower case equivalent,
     * and are not preceded by an underscore.
     * <ul>
     * <li>This provides for reasonable translations of upper case acronyms,
     * e.g., &quot;theWWW&quot; is translated to &quot;the_www&quot;.</li>
     * </ul>
     * </li>
     ...
     * <ul>
     * <li>For example, &quot;Results&quot; is translated to &quot;results&quot;,
     * and not to &quot;_results&quot;.</li>
     * </ul>
     * </li>
     ...
     * <ul>
     * <li>For example, &quot;user_Name&quot; is translated to
     ...
     * (unchanged, with two underscores)</li>
     * </ul>
     */
    ...
    public static class UpperSnakeCaseStrategy extends SnakeCaseStrategy {
        ...
        @Override
        public String translate(String input) {
            final String output = super.translate(input);
            if (output == null) {
                return null;
            }
     ...
     * Java property names to JSON element names.
     * <ul>
     * <li>&quot;userName&quot; is translated to &quot;UserName&quot;</li>
     * </ul>
     */
