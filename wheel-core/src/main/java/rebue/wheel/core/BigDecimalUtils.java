...
public class BigDecimalUtils {
    ...
    public static boolean equals(final Double value1, final Double value2) {
        final BigDecimal b1 = BigDecimal.valueOf(value1);    // 注意: 在构造Double类型的BigDecimal时不能直接用new
        // BigDecimal(Double)的方法
        final BigDecimal b2 = BigDecimal.valueOf(value2);    // 注意: 在构造Double类型的BigDecimal时不能直接用new
        // BigDecimal(Double)的方法
    ...
    public static Double divide(final Double dividend, final Double divisor) {
        final BigDecimal b1 = BigDecimal.valueOf(dividend);  // 注意: 在构造Double类型的BigDecimal时不能直接用new
        // BigDecimal(Double)的方法
        final BigDecimal b2 = BigDecimal.valueOf(divisor);   // 注意: 在构造Double类型的BigDecimal时不能直接用new
        // BigDecimal(Double)的方法
