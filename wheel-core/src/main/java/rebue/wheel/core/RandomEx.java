...
public class RandomEx {
     ...
     * 随机生成手机号码
     */
    private static String[] telFirst = "130,131,132,133,134,135,136,137,138,139,150,151,152,153,155,156,157,158,159"
            .split(",");
    ...
    // 随机生成省、自治区、直辖市代码 1-2
    private static String[] provinces = { "11", "12", "13", "14", "15", "21", "22", "23", "31", "32", "33", "34", "35",
     ...
     * 随机生成地址
     */
    private static String[] area   = "广西南宁市,广东广州市,广东东莞市,陕西西安市,内蒙古包头市,四川成都市,福建厦门市,山东青岛市,山东大连市,浙江杭州市,浙江温州市,湖南长沙市,湖北武汉市,湖北襄阳市,江苏南昌市,河南洛阳市,河南开封市,北京市,深圳市,上海市,天津市,重庆市"
            .split(",");
    ...
    public static String randomAddress() {
        ...
        final String third  = random.nextInt(20) + 1 + "栋" + (random.nextInt(3) + 1) + "单元" + (random.nextInt(9) + 1)
                + "0" + (random.nextInt(6) + 1) + "室";
