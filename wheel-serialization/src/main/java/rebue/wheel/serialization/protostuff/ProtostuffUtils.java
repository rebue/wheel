...
public class ProtostuffUtils {
    ...
    public static <T> byte[] serialize(final T obj) {
        ...
        try {
            if (obj instanceof Map) {
                ...
                @SuppressWarnings("unchecked") final Class<Wrapper<T>> cls     = (Class<Wrapper<T>>) wrapper.getClass();
                ...
                @SuppressWarnings("unchecked") final Class<T> cls    = (Class<T>) obj.getClass();
    ...
    public static <T> T deserialize(final byte[] data, final Class<T> cls) {
        if (cls.isAssignableFrom(Map.class)) {
            @SuppressWarnings("rawtypes") final Schema<Wrapper> schema  = RuntimeSchema.getSchema(Wrapper.class);
            @SuppressWarnings("unchecked") final Wrapper<T>     message = schema.newMessage();
