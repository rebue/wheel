/**
 * 复制io.vertx.ext.web.impl.ForwardedParserEx，让HttpServerRequestWrapperEx编译不出错
 *
...
public class ForwardedParserEx {
    ...
    ForwardedParserEx(HttpServerRequest delegate, AllowForwardHeaders allowForward) {
